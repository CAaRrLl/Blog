...
create table admin(
    ...
    email varchar(20) not null,         //账号(邮箱)
    phone varchar(20) not null,         //账号(手机)
...
create table essay(
    ...
    size int not null,                  //文章字数
    readtime int default 0,             //已读次数
    status int default 1,               //状态(删除:-1,发布:1,未发布:0)
...
create table collection(
    account varchar(20) not null,       //收藏者
    id int not null                     //发布的文章
)
```
##### 6.静态文件信息
```
